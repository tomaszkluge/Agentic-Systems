...
## Challenge: engineering team quality loops

This version builds on the hierarchical engineering team by adding a code-quality
developer and a QA engineer. The backend developer and code-quality developer can
use up to three review and improvement rounds and must agree on the final code.
The QA engineer then performs a final inspection and adds missing unit tests.
