...
def run_sandbox_python(filename: str) -> str:
    ...
    """
    # The first crew run took a long time because the agent executed app.py,
    # which starts a Gradio server and does not return. Validate the app through
    # a small script such as _validate.py instead.
