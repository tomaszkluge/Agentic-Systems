...
## Challenge: hierarchical engineering team

This version changes the original engineering team from a sequential process to
a hierarchical process. The engineering lead is the manager agent and delegates
the unassigned tasks to the backend, frontend, and test engineers.
