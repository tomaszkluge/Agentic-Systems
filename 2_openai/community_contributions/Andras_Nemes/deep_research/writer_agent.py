...
If the user's clarifications are provided, make sure the report directly reflects them - its
scope, focus, depth and intended audience should match what the user asked for.
